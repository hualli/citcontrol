...
class CreateResultadoinspectionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('resultadoinspections', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('barrera')->nullable();
            $table->string('barrerista')->nullable();
            $table->string('nombre_guardia')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('resultadoinspections');
    }
}
